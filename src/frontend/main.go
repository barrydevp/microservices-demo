...
func main() {
	...
	r.HandleFunc("/cart/checkout-saga", svc.placeOrderSagaHandler).Methods(http.MethodPost)
	r.HandleFunc("/order/{id}", svc.getOrderHandler).Methods(http.MethodGet, http.MethodHead)
