...
var file_demo_proto_rawDesc = []byte{
	...
	0x00, 0x32, 0xc8, 0x02, 0x0a, 0x0f, 0x43, 0x68, 0x65, 0x63, 0x6b, 0x6f, 0x75, 0x74, 0x53, 0x65,
	...
	0x74, 0x65, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x32, 0x48, 0x0a, 0x09,
...
var file_demo_proto_depIdxs = []int32{
	...
	14, // 46: hipstershop.CheckoutService.GetQuote:input_type -> hipstershop.GetQuoteRequest
	33, // 47: hipstershop.AdService.GetAds:input_type -> hipstershop.AdRequest
	6,  // 48: hipstershop.CartService.AddItem:output_type -> hipstershop.Empty
	5,  // 49: hipstershop.CartService.GetCart:output_type -> hipstershop.Cart
	6,  // 50: hipstershop.CartService.EmptyCart:output_type -> hipstershop.Empty
	8,  // 51: hipstershop.RecommendationService.ListRecommendations:output_type -> hipstershop.ListRecommendationsResponse
	10, // 52: hipstershop.ProductCatalogService.ListProducts:output_type -> hipstershop.ListProductsResponse
	9,  // 53: hipstershop.ProductCatalogService.GetProduct:output_type -> hipstershop.Product
	13, // 54: hipstershop.ProductCatalogService.SearchProducts:output_type -> hipstershop.SearchProductsResponse
	15, // 55: hipstershop.ShippingService.GetQuote:output_type -> hipstershop.GetQuoteResponse
	18, // 56: hipstershop.ShippingService.ShipOrder:output_type -> hipstershop.ShipOrderResponse
	18, // 57: hipstershop.ShippingService.ShipOrderTxn:output_type -> hipstershop.ShipOrderResponse
	...
	26, // 60: hipstershop.PaymentService.Charge:output_type -> hipstershop.ChargeResponse
	26, // 61: hipstershop.PaymentService.ChargeTxn:output_type -> hipstershop.ChargeResponse
	6,  // 62: hipstershop.EmailService.SendOrderConfirmation:output_type -> hipstershop.Empty
	32, // 63: hipstershop.CheckoutService.PlaceOrder:output_type -> hipstershop.PlaceOrderResponse
	32, // 64: hipstershop.CheckoutService.PlaceOrderSaga:output_type -> hipstershop.PlaceOrderResponse
	28, // 65: hipstershop.CheckoutService.GetOrder:output_type -> hipstershop.OrderResult
	15, // 66: hipstershop.CheckoutService.GetQuote:output_type -> hipstershop.GetQuoteResponse
	34, // 67: hipstershop.AdService.GetAds:output_type -> hipstershop.AdResponse
...
func (c *checkoutServiceClient) GetQuote(ctx context.Context, in *GetQuoteRequest, opts ...grpc.CallOption) (*GetQuoteResponse, error) {
	out := new(GetQuoteResponse)
	err := c.cc.Invoke(ctx, "/hipstershop.CheckoutService/GetQuote", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (*UnimplementedCheckoutServiceServer) GetQuote(context.Context, *GetQuoteRequest) (*GetQuoteResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetQuote not implemented")
}
...
func _CheckoutService_GetQuote_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetQuoteRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(CheckoutServiceServer).GetQuote(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/hipstershop.CheckoutService/GetQuote",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CheckoutServiceServer).GetQuote(ctx, req.(*GetQuoteRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _CheckoutService_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "GetQuote",
			Handler:    _CheckoutService_GetQuote_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "demo.proto",
